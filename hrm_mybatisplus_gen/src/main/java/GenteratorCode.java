    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("OutputDirXml")+ "/cn/xiaji/hrm/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/controller.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("OutputDir")+ "/cn/xiaji/hrm/web/controller/" + tableInfo.getEntityName() + "Controller.java";
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/entity.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("InterfaceOutputDirBase")+ "/cn/xiaji/hrm/domain/" + tableInfo.getEntityName() + ".java";
            }
        });
        // 调整 query 生成目录演示
        focList.add(new FileOutConfig("/templates/query.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("InterfaceOutputDirBase")+ "/cn/xiaji/hrm/query/" + tableInfo.getEntityName() + "Query.java";
            }
        });
        // 调整 client 生成目录演示
